...
class InceptionV4_parallel(nn.Module):
    ...
    def __init__(
        ...
        self.inception_a1_1 = InceptionA(384)
        self.inception_a1_2 = InceptionA(384)
        
        self.inception_a2_1 = InceptionA(384)
        self.inception_a2_2 = InceptionA(384)
        
        self.inception_a3_1 = InceptionA(384)
        self.inception_a3_2 = InceptionA(384)
        
        self.inception_a4_1 = InceptionA(384)
        self.inception_a4_2 = InceptionA(384)
        
        # Reduction-A blocks
        self.reduction_a1 = ReductionA(384, k, l, m, n)
        self.reduction_a2 = ReductionA(384, k, l, m, n)
        
        # Inception-B blocks
        self.inception_b1_1 = InceptionB(1024)
        self.inception_b1_2 = InceptionB(1024)

        self.inception_b2_1 = InceptionB(1024)
        self.inception_b2_2 = InceptionB(1024)

        self.inception_b3_1 = InceptionB(1024)
        self.inception_b3_2 = InceptionB(1024)
        
        self.inception_b4_1 = InceptionB(1024)
        self.inception_b4_2 = InceptionB(1024)

        self.inception_b5_1 = InceptionB(1024)
        self.inception_b5_2 = InceptionB(1024)

        self.inception_b6_1 = InceptionB(1024)
        self.inception_b6_2 = InceptionB(1024)

        self.inception_b7_1 = InceptionB(1024)
        self.inception_b7_2 = InceptionB(1024)
        
        # Reduction-B blocks
        self.reduction_b1 = ReductionB(1024)
        self.reduction_b2 = ReductionB(1024)
        
        # Inception-C blocks
        self.inception_c1_1 = InceptionC(1536)
        self.inception_c1_2 = InceptionC(1536)

        self.inception_c2_1 = InceptionC(1536)
        self.inception_c2_2 = InceptionC(1536)

        self.inception_c3_1 = InceptionC(1536)
        self.inception_c3_2 = InceptionC(1536)
